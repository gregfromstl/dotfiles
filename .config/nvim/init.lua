...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- If encountering errors, see telescope-fzf-native README for installation instructions
        ...
        -- This is only run when the plugin is installed or updated, not every time Neovim starts up.
        build = 'make',
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          file_browser = {
            ...
            file_ignore_patterns = { 'node_modules', '.cache', '.DS_Store' },
            mappings = {
              ['i'] = {
      ...
      vim.keymap.set('n', '<space>fb', ':Telescope file_browser path=%:p:h select_buffer=true<CR><esc>', { desc = 'Open the [F]ile [B]rowser' })
  ...
  --  Uncomment any of the lines below to enable these plugins (you will need to restart nvim).
  --
